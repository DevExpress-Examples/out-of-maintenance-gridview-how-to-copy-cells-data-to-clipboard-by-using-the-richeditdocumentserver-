...
'ORIGINAL LINE: table.Borders.Left.LineColor = table.Borders.Right.LineColor = table.Borders.InsideVerticalBorder.LineColor = gridView1.PaintAppearance.VertLine.BackColor;
			table.Borders.InsideVerticalBorder.LineColor = gridView1.PaintAppearance.VertLine.BackColor
'INSTANT VB WARNING: An assignment within expression was extracted from the following statement:
'ORIGINAL LINE: table.Borders.Left.LineColor = table.Borders.Right.LineColor = table.Borders.InsideVerticalBorder.LineColor
...
'INSTANT VB WARNING: An assignment within expression was extracted from the following statement:
'ORIGINAL LINE: table.Borders.Left.LineThickness = table.Borders.Right.LineThickness = table.Borders.InsideVerticalBorder.LineThickness = thickness;
			table.Borders.InsideVerticalBorder.LineThickness = thickness
'INSTANT VB WARNING: An assignment within expression was extracted from the following statement:
'ORIGINAL LINE: table.Borders.Left.LineThickness = table.Borders.Right.LineThickness = table.Borders.InsideVerticalBorder.LineThickness
...
'INSTANT VB WARNING: An assignment within expression was extracted from the following statement:
'ORIGINAL LINE: table.Borders.Left.LineStyle = table.Borders.Right.LineStyle = table.Borders.InsideVerticalBorder.LineStyle = TableBorderLineStyle.Single;
			table.Borders.InsideVerticalBorder.LineStyle = TableBorderLineStyle.Single
'INSTANT VB WARNING: An assignment within expression was extracted from the following statement:
'ORIGINAL LINE: table.Borders.Left.LineStyle = table.Borders.Right.LineStyle = table.Borders.InsideVerticalBorder.LineStyle
...
'INSTANT VB WARNING: An assignment within expression was extracted from the following statement:
'ORIGINAL LINE: table.Borders.Bottom.LineColor = table.Borders.Top.LineColor = table.Borders.InsideHorizontalBorder.LineColor = gridView1.PaintAppearance.HorzLine.BackColor;
			table.Borders.InsideHorizontalBorder.LineColor = gridView1.PaintAppearance.HorzLine.BackColor
'INSTANT VB WARNING: An assignment within expression was extracted from the following statement:
'ORIGINAL LINE: table.Borders.Bottom.LineColor = table.Borders.Top.LineColor = table.Borders.InsideHorizontalBorder.LineColor
...
'INSTANT VB WARNING: An assignment within expression was extracted from the following statement:
'ORIGINAL LINE: table.Borders.Bottom.LineThickness = table.Borders.Top.LineThickness = table.Borders.InsideHorizontalBorder.LineThickness = thickness;
			table.Borders.InsideHorizontalBorder.LineThickness = thickness
'INSTANT VB WARNING: An assignment within expression was extracted from the following statement:
'ORIGINAL LINE: table.Borders.Bottom.LineThickness = table.Borders.Top.LineThickness = table.Borders.InsideHorizontalBorder.LineThickness
...
'INSTANT VB WARNING: An assignment within expression was extracted from the following statement:
'ORIGINAL LINE: table.Borders.Bottom.LineStyle = table.Borders.Top.LineStyle = table.Borders.InsideHorizontalBorder.LineStyle = TableBorderLineStyle.Single;
			table.Borders.InsideHorizontalBorder.LineStyle = TableBorderLineStyle.Single
'INSTANT VB WARNING: An assignment within expression was extracted from the following statement:
'ORIGINAL LINE: table.Borders.Bottom.LineStyle = table.Borders.Top.LineStyle = table.Borders.InsideHorizontalBorder.LineStyle
		...
		Private Sub CopyToClipboard()
			...
			Dim rows = From c In cells
				Group c By c.RowHandle Into gr = Group
				Order By RowHandle
				Select gr
			Dim columns = From c In cells
				Group c By c.Column Into gr = Group
				Order By Column.VisibleIndex
				Select gr
			Dim srv As New RichEditDocumentServer()
			srv.CreateNewDocument()
			Dim table As Table = srv.Document.Tables.Create(srv.Document.CaretPosition, rows.Count() + 1, columns.Count())
			SetBorders(table)
